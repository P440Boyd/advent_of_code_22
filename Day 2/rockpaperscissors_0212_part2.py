...
class Round:
    ...
    def __init__(self, line) -> None:
        self.translation_dict = {"A":"rock", "B":"paper", "C":"scissors", "X": "lose", "Y":"draw", "Z":"win"}
    ...
    def evaluate_scores(self):
        ...
        return self.choice_score_dict[my_choice] + self.result_score_dict[self.desired_outcome]
...
def main():
    ...
    with open("game_results.txt", "w+") as result_fp:
        for line in input_lines:
            ...
            result_fp.write(f"Their choice: {game_round.their_choice}. Desired outcome is: {game_round.desired_outcome}. My score: {my_score}.\n")
